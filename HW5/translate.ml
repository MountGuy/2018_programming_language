 ...
 *)
 ...
 module Translator = struct
   ...
   let rec trans : K.program -> Sm5.command = function
     ...
     | K.WHILE (e1, e2) ->
       trans (K.LETF("#whileLoop", "#annonymous", K.IF(e1, K.SEQ(e2, K.CALLV("#whileLoop", K.NUM(1))), K.UNIT), K.CALLV("#whileLoop", K.NUM(1))))
     | K.FOR (x, e1, e2 ,e3) ->
       trans (
         K.LETV("#start", e1, 
             K.LETV("#end", e2,
     ...
     | K.WRITE e -> trans e @ [Sm5.MALLOC; Sm5.BIND "#buffer"; Sm5.PUSH (Sm5.Id("#buffer")); Sm5.STORE;
                               Sm5.PUSH (Sm5.Id("#buffer")); Sm5.LOAD; Sm5.PUT;
                               Sm5.PUSH (Sm5.Id("#buffer")); Sm5.LOAD; Sm5.UNBIND; Sm5.POP]
